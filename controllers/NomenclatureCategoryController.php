...
/**
 * NomenclatureCategoryController implements the CRUD actions for NomenclatureCategory model.
 */
class NomenclatureCategoryController extends Controller
{
    /**
     * @inheritDoc
     */
    ...
    /**
     * Displays a single NomenclatureCategory model.
     * @param int $id ID
     * @return string
    ...
    public function actionCreate()
    {
        ...
        // Здесь передается $id несуществующей каьегории, чтобы вернуть все объекты
        $allowedCategories = $model->getAllowedParentCategories(0);
    ...
    public function actionUpdate($id)
    {
        ...
        $allowedCategories = $model->getAllowedParentCategories($id);
